...
{
    public class QuizReadModelDbContext : DbContext
    {
        public DbSet<QuizReadModel> Quizes { get; set; }

        public QuizReadModelDbContext(DbContextOptions<QuizReadModelDbContext> options) : base(options)
        {
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<QuizReadModel>(entity =>
            {
