...
{
    public class QuestionReadModelDbContext : DbContext
    {
        public DbSet<QuestionReadModel> Questions { get; set; }

        public QuestionReadModelDbContext(DbContextOptions<QuestionReadModelDbContext> options) : base(options)
        {
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<QuestionReadModel>(entity =>
            {
